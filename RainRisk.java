...
Figure out where the navigation instructions actually lead. What is the Manhattan distance between that location and the ship's starting position?
    ...
    private static int part2(Scanner myReader) {
        ...
        while (myReader.hasNextLine())
        {
            ...
            {
                west+=num;
            }else if (line.charAt(0)=='R' || line.charAt(0)=='L')
            {
                int degree =(((num/90)*((line.charAt(0)=='L')?-1:1))+4)%4;
                if (degree == 1)
                {
                    int save = north;
                    north = west;
            ...
            {
                resultNorth += ((north)-(south))*num;
                resultEast += ((east)-(west))*num;
            }
        ...
        System.out.println(west);
        System.out.println(east);
        return Math.abs(resultNorth)+Math.abs(resultEast);
